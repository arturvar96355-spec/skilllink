...
| Что | Число |
| --- | --- |
| Моделей в схеме (`prisma/schema.prisma`) | 47 |
| Миграций (`prisma/migrations`) | 31 |
| Маршрутов API (`src/app/api/**/route.ts`) | 144 |
| Операций в спецификации (`docs/openapi.json`) | 174 |
...
| Полнота демо-данных (`npm run demo:coverage`) | 47 модели, 0 пустых содержательных таблиц |
