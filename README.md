...
252 теста: таблица переходов этапов, условия завершения и блокировки, автоматический пересчёт
...
266 проверок по разделам 17 и 18 ТЗ: подключение к базе, дашборд, реестр вузов, создание вуза
...
групповые операции по продукту, сборку пакета документов из шаблонов и вход по паролю.
