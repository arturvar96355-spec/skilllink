...
| Миграций (`prisma/migrations`) | 27 |
| Маршрутов API (`src/app/api/**/route.ts`) | 135 |
| Операций в спецификации (`docs/openapi.json`) | 162 |
...
| Полнота демо-данных (`npm run demo:coverage`) | 44 модели, 0 пустых содержательных таблиц |
