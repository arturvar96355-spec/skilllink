...
| Миграций (`prisma/migrations`) | 29 |
| Маршрутов API (`src/app/api/**/route.ts`) | 141 |
| Операций в спецификации (`docs/openapi.json`) | 171 |
...
| Полнота демо-данных (`npm run demo:coverage`) | 46 модели, 0 пустых содержательных таблиц |
