...
async function main(): Promise<void> {
  ...
  // Расширенный набор (решение 131): 50 связок, из них 40 в работе и черновиках.
  ...
  check('дней до начала занятий в среднем', metric('avgDaysToClasses'), 187.4)
  ...
  // сроки сдвинуты за конец экспертизы — число держится до 14.10 (решение 131).
  ...
  // Kubernetes и PostgreSQL — как прежде, MLOps — третий (решение 131).
  ...
  check(
    ...
    [
      ...
      // баллы вузов сценария не сдвинулись (решение 131).
