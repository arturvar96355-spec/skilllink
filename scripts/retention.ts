 ...
 *
 * На стенде запускается ролью-владельцем базы через сервис migrate. Когда роль
 * приложения отделят от владельца (после защиты, решение 88), у неё права удалять
 * журнал не будет. Расписание — cron владельца сервера, docs/DEPLOY.md; пока не включено.
 *
