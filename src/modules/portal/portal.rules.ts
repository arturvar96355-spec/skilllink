 ...
 * «Передача учебных материалов, лицензии и документации».
 */
 ...
 *
 * Сотрудник ИТ-Школы кабинет любого вуза открывает, но только смотрит. Подтверди он
 * получение материалов, внеси показатели или подай заявку от имени вуза — в системе
 * выглядело бы, что это сделал вуз.
 */
