...
/**
 * Статистика проверки рекомендаций (решение 136): квантили, интервалы для долей
 * (Уилсон, 10 Ньюкомба) и для средних (Уэлч), последовательная проверка Вальда.
 * Ручные примеры сверены независимым расчётом — docs/TECHNICAL_DECISIONS.md, раздел 136.
 */
