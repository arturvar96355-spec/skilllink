 ...
 * как UTF-8, превращается в мусор уже в строке заголовков, и система ответила бы
 * «Не найдены: Название, Город, Регион», хотя в файле эти колонки на месте.
 *
 ...
 * и в любом другом двоичном файле. Прочитанный как Windows-1251, такой файл дал бы
 * то «не найдены колонки» при колонках на месте, то внутреннюю ошибку на записи:
 * символ с кодом 0 база не принимает (shared/db/storable.ts).
 */
