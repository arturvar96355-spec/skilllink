...
const cooperationFields = {
  /** Продукт может быть не выбран на ранних этапах: при создании связки он необязателен. */
...
export const createCooperationSchema = z.object({
  ...
  ...cooperationFields,
  /**
   * Новая связка — открытая. Созданная сразу «завершённой» получила бы четырнадцать
