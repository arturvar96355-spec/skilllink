...
export const ENDPOINTS: readonly EndpointSpec[] = [
  ...
  },
  {
    ...
    description:
      'Ст. 14 152-ФЗ. JSON вложением, без кэша: subject, operator, purposes, legalBasis, categories, sources, ' +
  ...
  },
  {
    ...
    description:
      'Ст. 20, 21 152-ФЗ. Тело { confirm: логин }. В одной транзакции по реестру: ФИО, почта, должность — заглушка, ' +
