...
export const AUDIT_ACTIONS = [
  ...
  'ai.draft',
  /**
   * «История сотрудничества» по связке или вузу (решение 138): источник — модель
   * или шаблон, причина отказа модели. Без текста истории.
   */
  'ai.story',
  /**
   * Обращение к модели (решение 138): каждый вызов — свой при формулировке истории,
   * не только успешные. В payload — провайдер, объём фактов символами, исход.
   * Без текста запроса и ответа.
   */
  'ai.request',
  /** Проект «Предложить план» построен: вид (встреча или новый срок этапа). Без записи в базу. */
  'ai.proposal.created',
  /** Проект плана применён: создана встреча или перенесён срок этапа штатным сервисом. */
  'ai.proposal.applied',
