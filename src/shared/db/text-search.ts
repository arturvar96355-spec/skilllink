 ...
 *
 * Строкой целиком запрос «спбгут программная» не совпадал ни с одним полем —
 * краткое имя вуза в одном, название программы в другом, — и человек получал
 * «Ничего не найдено» по записи, которую видел на экране. Слова связаны «И»,
