 ...
 *
 * Проверка на входе API знала о смысле полей, но не о типах колонок. Всё, что
 * проходило Zod и не помещалось в базу, доходило до запроса и возвращалось как
 * «Внутренняя ошибка сервера» — вместо понятного отказа с именем поля. Отсюда
 * проверки входа берут пределы базы, а не угадывают их по месту.
 */
 ...
 * и «Студентов: 99 999 999 999» проходило проверку, а падало на записи.
 */
