 ...
 * и человек чинил бы не то. Типичный случай: пароль в настройках разошёлся
 * с тем, с которым создан том базы, а подсказка «запустите PostgreSQL» уводит
 * к серверу, который и так работает.
 */
