 ...
 */
/**
 * Профиль программы для дефицитов навыков (решение 98, решение Артура).
 *
 * Дефициты считаются против всего рынка, и магистратуре ИИ «не хватало» Java.
 ...
 *
 * Отдельно от остальных блоков: по решению Артура список проблем — главный
 * блок первого экрана, и пяти строк ему мало. Сколько их всего, сводка
