...
export const API_ROUTE_TEMPLATES: readonly string[] = [
  ...
  '/api/auth/[...nextauth]',
  '/api/calendar/[feed]',
  '/api/channels/max/webhook',
  '/api/channels/vk/callback',
  '/api/client-errors',
  ...
  '/api/import/vendors',
  '/api/inbound-letters',
  '/api/inbound-letters/[id]',
  '/api/inbound-letters/[id]/analyze',
  ...
  '/api/settings/workflow/stages/[number]',
  '/api/skills',
  '/api/skills/[id]',
  '/api/skills/[id]/merge',
  '/api/skills/demand',
  ...
  '/api/universities/[id]/responsible',
