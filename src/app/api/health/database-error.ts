 ...
 * и человек чинил бы не то. Так и вышло при первом развёртывании: пароль
 * в настройках разошёлся с тем, с которым создан том базы, а подсказка
 * советовала запустить PostgreSQL, который и так работал.
 */
